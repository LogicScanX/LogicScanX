...
def banner():
    ...
    console.print(Panel.fit(
        "[bold cyan]╔═══════════════════════════════════╗\n"
        "║    [bold yellow]    Logic ScanX[/bold yellow]                ║\n"
    "║                                   ║\n"
...
def dev_info():
    ...
    console.print(Panel.fit(
        ...
        "[bold]Name:[/bold] Akash Deep\n"
        "[bold]YouTube:[/bold] Logic ScanX\n"
        "[bold]Tool:[/bold] Multi Advanced Tool v2.0\n"
        "[bold]Version:[/bold] 2.0\n"
        "[bold]Release Date:[/bold] 2026\n\n"
        "[yellow]This tool is povred by Akash Deep (don't copy tool).[/yellow]\n"
...
def main():
    while True:
        ...
        if choice == "14":
            banner()
            console.print(Panel.fit("[bold green]Thank you for using Logic ScanX Tool![/bold green]\n[yellow]Goodbye![/yellow]", border_style="red"))
            break
